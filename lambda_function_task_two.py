...
print("Максимальное количество очков: ",(max(grades,key=lambda elem:elem["score"]))["score"])
print("Минимальное количество очков: ",(min(grades,key=lambda elem:elem["score"]))["score"])